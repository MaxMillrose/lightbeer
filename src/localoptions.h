...
In this file we override the default values. Maybe later on we switch to  hardcode default_options.h
...
#define DSS_PRIV_FILENAME "./lightbeer_dss_host_key"
#define RSA_PRIV_FILENAME "./lightbeer_rsa_host_key"
#define ECDSA_PRIV_FILENAME "./lightbeer_ecdsa_host_key"
#define ED25519_PRIV_FILENAME "./lightbeer_ed25519_host_key"
...
/* That a BIG FUVKING NOTE we don't want that! This is not recommened!!! */
/* and the spelling of fuvking is intentional*/
...
/* Client authentication options TODO:Remove */
